...
const routes: Routes = [
  ...
  { path: 'motifDispo', data: {breadcrumb: 'Gestion des motifs de la disponibilite'}, loadChildren: () => import('./parametre/motif-disponibilite/motif-disponibilite.module').then(m => m.MotifDisponibiliteModule) },
